$(document).ready(function() {
    ...
    $(document).delegate('.edit', 'click', function() {
        ...
        firstName.html("<input type='text' id='txtFirstName' value='" + firstName.html() + "'/>");
        lastName.html("<input type='text' id='txtLastName' value='" + lastName.html() + "'/>");
        departmentId.html("<input type='text' id='txtDepartmentId' value='" + departmentId.html() + "'/>");
        jobTitle.html("<input type='text' id='txtJobTitle' value='" + jobTitle.html() + "'/>");
        gender.html("<input type='text' id='txtGender' value='" + gender.html() + "'/>");
        dateOfBirth.html("<input type='text' id='txtDateOfBirth' value='" + dateOfBirth.html() + "'/>");
